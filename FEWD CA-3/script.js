...
function displayRandomMeal(data) {
    ...
    container.classList.add("meal-container1"); // Optional: Add a class for styling
    container.style.textAlign = "left"; // Center align the content
    container.style.marginTop = "20px";


    const randomMealLine = document.createElement("p");
  randomMealLine.textContent = "RANDOM MEAL";
  randomMealLine.style.fontWeight = "bold"; // Optional: Add styles as needed
  container.appendChild(randomMealLine);
    ...
    randomMealContainer.innerHTML = ''; // Clear previous content
...
function displayCategoryMeals(meals) {
    ...
    meals.forEach((meal) => {
        ...
        mealContainer.classList.add("meal-container"); // Optional: Add a class for styling

        const img = document.createElement("img");
        img.alt = meal.strMeal;
        img.src = meal.strMealThumb; // Set the correct URL for the image
